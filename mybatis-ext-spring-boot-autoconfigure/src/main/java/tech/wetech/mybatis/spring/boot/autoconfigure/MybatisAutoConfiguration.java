 ...
 */
package tech.wetech.mybatis.spring.boot.autoconfigure;
...
public class MybatisAutoConfiguration implements InitializingBean {
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
        ExtSqlSessionFactoryBean factory = new ExtSqlSessionFactoryBean();
    ...
    private void applyConfiguration(ExtSqlSessionFactoryBean factory) {
        ExtConfiguration configuration = this.properties.getConfiguration();
