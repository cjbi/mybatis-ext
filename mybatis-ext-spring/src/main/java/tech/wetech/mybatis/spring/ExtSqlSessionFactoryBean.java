 ...
 * @see #setDataSource
 */
public class ExtSqlSessionFactoryBean
        implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {

    private static final Logger LOGGER = LoggerFactory.getLogger(org.mybatis.spring.SqlSessionFactoryBean.class);
    ...
    protected SqlSessionFactory buildSqlSessionFactory() throws Exception {
        ...
        final ExtConfiguration targetConfiguration;

        ExtXMLConfigBuilder xmlConfigBuilder = null;
        if (this.configuration != null) {
            ...
            xmlConfigBuilder = new ExtXMLConfigBuilder(this.configLocation.getInputStream(), null, this.configurationProperties);
            targetConfiguration = xmlConfigBuilder.getConfiguration();
        } else {
            LOGGER.debug(
                    () -> "Property 'configuration' or 'configLocation' not specified, using default MyBatis Configuration");
            targetConfiguration = new ExtConfiguration();
